...
function (_Component) {
  ...
  function TransitionablePortal(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleTransitionHide", function (nothing, data) {
      ...
      (0, _invoke2.default)(_this.props, 'onClose', null, _objectSpread({}, data, {
        portalOpen: false,
        transitionVisible: false
      }));
      (0, _invoke2.default)(_this.props, 'onHide', null, _objectSpread({}, data, {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleTransitionStart", function (nothing, data) {
      ...
      (0, _invoke2.default)(_this.props, 'onStart', null, _objectSpread({}, data, {
        portalOpen: portalOpen,
      ...
      (0, _invoke2.default)(_this.props, 'onOpen', null, _objectSpread({}, data, {
        transitionVisible: transitionVisible,
        portalOpen: true
      }));
    });
