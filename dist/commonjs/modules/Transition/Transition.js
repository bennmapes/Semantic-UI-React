  ...
  function Transition() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleStart", function () {
      ...
      _this.setState({
        ...
        (0, _invoke2.default)(_this.props, 'onStart', null, _objectSpread({}, _this.props, {
          status: status
        }));
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleComplete", function () {
      ...
      (0, _invoke2.default)(_this.props, 'onComplete', null, _objectSpread({}, _this.props, {
        status: current
      }));
      ...
      _this.setState({
        ...
        (0, _invoke2.default)(_this.props, callback, null, _objectSpread({}, _this.props, {
          status: status
        }));
      });
    });
