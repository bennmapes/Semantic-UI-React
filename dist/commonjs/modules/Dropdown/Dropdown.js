...
function (_Component) {
  ...
  function Dropdown() {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleChange", function (e, value) {
      (0, _invoke2.default)(_this.props, 'onChange', e, _objectSpread({}, _this.props, {
        value: value
      }));
    });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "makeSelectedItemActive", function (e) {
      ...
      if (valueHasChanged) {
        ...
        if (item['data-additional']) {
          (0, _invoke2.default)(_this.props, 'onAddItem', e, _objectSpread({}, _this.props, {
            value: selectedValue
          }));
        }
      }
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleClearIconClick", function (e) {
      var clearable = _this.props.clearable;
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleItemClick", function (e, item) {
      ...
      if (isAdditionItem) (0, _invoke2.default)(_this.props, 'onAddItem', e, _objectSpread({}, _this.props, {
        value: value
      }));
      if (search) (0, _invoke2.default)(_this.searchRef.current, 'focus');
    });
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleSearchChange", function (e, _ref) {
      ...
      var newQuery = value;
      (0, _invoke2.default)(_this.props, 'onSearchChange', e, _objectSpread({}, _this.props, {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleIconOverrides", function (predefinedProps) {
      ...
      return {
        ...
        disabled: !_this.hasValue()
      };
    });
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "handleClearIconOverrides", function (predefinedProps) {
      var clearable = _this.props.clearable;
      var classes = (0, _classnames.default)(clearable && _this.hasValue(), predefinedProps.className);
      return {
        className: classes,
        onClick: function onClick(e) {
          (0, _invoke2.default)(predefinedProps, 'onClick', e, predefinedProps);

          _this.handleClearIconClick(e);
        }
      };
    });
