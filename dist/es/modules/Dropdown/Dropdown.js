...
function (_Component) {
  ...
  function Dropdown() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClearIconClick", function (e) {
      var clearable = _this.props.clearable;
    ...
    _defineProperty(_assertThisInitialized(_this), "handleClearIconOverrides", function (predefinedProps) {
      var clearable = _this.props.clearable;
      var classes = cx(clearable && _this.hasValue(), predefinedProps.className);
      return {
        className: classes,
        onClick: function onClick(e) {
          _invoke(predefinedProps, 'onClick', e, predefinedProps);
